...
class OrderController extends AbstractAdminController
{
	protected function grid()
	{
		...
		$grid->column('pay_state', Order::labels()['pay_state']);
		...
		$grid->column('out_state', Order::labels()['out_state']);
	...
	protected function form($isEdit = false)
	{
		...
		$form->item('pay_state', Order::labels()['pay_state']);
		...
		$form->item('out_state', Order::labels()['out_state']);
